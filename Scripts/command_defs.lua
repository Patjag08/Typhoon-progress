...
device_commands =
{
	...
	HTAONOFF			= __counter(),
	MidsONOFF			= __counter(),
	Radio_02ONOFF		= __counter(),
	Radio_01ONOFF		= __counter(),
	VoiceONOFF			= __counter(),
	RADARONOFF			= __counter(),
	AIRTOAIR			= __counter(),
	NAVMODE				= __counter(),
	APUON				= __counter(),
	APUSTANDBYOFF		= __counter(),
	ECS 				= __counter(),
	AIRDRIVE			= __counter(),
	LANDONOFF			= __counter(),
	ACOLLISIONONOFF		= __counter(),
	FORMATIONONOFF		= __counter(),
	LBOOST				= __counter(),
	RBOOST				= __counter(),
	RCOVER				= __counter(),
	LCOVER				= __counter(),
