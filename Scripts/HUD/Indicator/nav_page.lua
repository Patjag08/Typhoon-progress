...
HUD_SQUARE_CLIP.element_params    = {"BATTERY","HUDONOFF"}
HUD_SQUARE_CLIP.controllers       = {{"parameter_compare_with_number",0,1},{"parameter_compare_with_number",1,0}}
...
HUD_RUMBOS_CLIP.element_params    = {"BATTERY","HUDONOFF"}
HUD_RUMBOS_CLIP.controllers       = {{"parameter_compare_with_number",0,1},{"parameter_compare_with_number",1,0}}
...
AOA_Scale.vertices                 = hud_vert_gen(1500-200,1250-200)
...
AOA_Scale.element_params           = {"HUD3ONOFF"}
AOA_Scale.controllers              = {{"parameter_compare_with_number",0,1}}
...
HUD_AOA_arrow.vertices                 = hud_vert_gen(1100-200,1300-200)
...
hud_vectorv_real.vertices                 = hud_vert_gen(230-10,230-10)
...
local hud_airbrk                    = CreateElement "ceTexPoly"
hud_airbrk.vertices                 = hud_vert_gen(300-50,300-50)
hud_airbrk.indices                  = {0,1,2,2,3,0}
hud_airbrk.tex_coords               = tex_coord_gen(0,0,2048,2048,2048,2048)
hud_airbrk.material                 = HUD_BRK
hud_airbrk.name                     = create_guid_string()
hud_airbrk.init_pos                 = {0.0035, -0.07, 0}
hud_airbrk.init_rot                 = {0, 0, 0}
hud_airbrk.element_params           = {"AIRBRK"}
hud_airbrk.controllers              = {{"parameter_compare_with_number",0,1},}
hud_airbrk.collimated               = true
hud_airbrk.use_mipfilter            = true
hud_airbrk.additive_alpha           = false
hud_airbrk.h_clip_relation          = h_clip_relations.COMPARE
hud_airbrk.level                    = HUD_DEFAULT_NOCLIP_LEVEL + 2
hud_airbrk.parent_element           = "HUD_ROLL_PI"
Add(hud_airbrk)

local hud_pullup                    = CreateElement "ceTexPoly"
hud_pullup.vertices                 = hud_vert_gen(1400-200,1400-200)
hud_pullup.indices                  = {0,1,2,2,3,0}
hud_pullup.tex_coords               = tex_coord_gen(0,0,2048,2048,2048,2048)
hud_pullup.material                 = HUD_PULLUP
hud_pullup.name                     = create_guid_string()
hud_pullup.init_pos                 = {0.0035, -0.07, 0}
hud_pullup.init_rot                 = {0, 0, 0}
hud_pullup.element_params           = {"PULLUP"}
hud_pullup.controllers              = {{"parameter_compare_with_number",0,1},}
hud_pullup.collimated               = true
hud_pullup.use_mipfilter            = true
hud_pullup.additive_alpha           = false
hud_pullup.h_clip_relation          = h_clip_relations.COMPARE
hud_pullup.level                    = HUD_DEFAULT_NOCLIP_LEVEL + 2
hud_pullup.parent_element           = "HUD_ROLL_PI"
Add(hud_pullup)


local hud_horizonte                   = CreateElement "ceTexPoly"
hud_horizonte.vertices                 = hud_vert_gen(3500-1200,2000-200)
...
hud_vectorv.vertices                 = hud_vert_gen(650-200,650-200)
...
hud_vectorv.element_params           = {"LOWSPEED"}
hud_vectorv.controllers              = {{"parameter_compare_with_number",0,0},}
...
local hud_vectorlow                    = CreateElement "ceTexPoly"
hud_vectorlow.vertices                 = hud_vert_gen(650-200,650-200)
hud_vectorlow.indices                  = {0,1,2,2,3,0}
hud_vectorlow.tex_coords               = tex_coord_gen(0,0,2048,2048,2048,2048)
hud_vectorlow.material                 = HUD_Lowsped
hud_vectorlow.name                     = create_guid_string()
hud_vectorlow.element_params           = {"LOWSPEED"}
hud_vectorlow.controllers              = {{"parameter_compare_with_number",0,1},}
hud_vectorlow.init_pos                 = {0, -0.07, 0}
hud_vectorlow.init_rot                 = {0, 0, 0}
hud_vectorlow.collimated               = true
hud_vectorlow.use_mipfilter            = true
hud_vectorlow.additive_alpha           = false
hud_vectorlow.h_clip_relation          = h_clip_relations.COMPARE
hud_vectorlow.level                    = HUD_DEFAULT_NOCLIP_LEVEL + 2
hud_vectorlow.parent_element           = "HUD_ROLL_PI"
Add(hud_vectorlow)
...
local hud_bank                   = CreateElement "ceTexPoly"         --DCLT
hud_bank.vertices                 = hud_vert_gen(2500-200,2500-200)
...
hud_bank.element_params           = {"HUD3ONOFF"}
hud_bank.controllers              = {{"parameter_compare_with_number",0,1},}
...
hud_bank_ind.vertices                 = hud_vert_gen(2500-200,2500-200)
...
hud_bank_ind.element_params           = {"HUD3ONOFF"}
hud_bank_ind.controllers              = {{"parameter_compare_with_number",0,1},}
...
hud_ang_positivo_5.vertices                 = hud_vert_gen(2000-700,2000-200)
...
hud_ang_numero_5.init_pos          = {-0.25, 0.41,0}      
...
hud_ang_numero_m5.init_pos          = {-0.25, -0.56,0}      
...
hud_ang_negativo_5.vertices                 = hud_vert_gen(2000-700,2000-200)
...
for i=2,18 do 
    ...
    hud_ang_positivo.vertices                 = hud_vert_gen(2000-700,2000-200)
    ...
    hud_ang_numero.init_pos          = {-0.25, vertical_distance - 0.05,0}      
...
for i=2,18 do 
    ...
    hud_ang_negativo.vertices                 = hud_vert_gen(2000-700,2000-200)
    ...
    local hud_ang_numero           = CreateElement "ceStringPoly" 
    hud_ang_numero.material          = "green_font_MPCD"             
    hud_ang_numero.init_pos          = {-0.25, -vertical_distance-0.09,0}      
    hud_ang_numero.alignment         = "LeftCenter"       
    hud_ang_numero.stringdefs        = {0.00650,0.00650, 0.0006, 0}  
    hud_ang_numero.formats           = {tostring(sign_number),"%s"} 
    hud_ang_numero.element_params    = {"HUD_ANG_NUM"}
...
HUD_Circle.vertices                 = hud_vert_gen(850-100,850-100)
HUD_Circle.indices                  = {0,1,2,2,3,0}
HUD_Circle.tex_coords               = tex_coord_gen(0,0,2048,2048,2048,2048)
HUD_Circle.init_pos                 = {0.55, 0.0, 0} --L-R,U-D,F-B
HUD_Circle.init_rot                 = {0 , 0, 0}
HUD_Circle.material                 = HUD_ALTCIRCLE
HUD_Circle.name                     = create_guid_string()
HUD_Circle.init_pos                 = {0.55 , 0.2 , 0}
HUD_Circle.element_params           = {"HUD3ONOFF"}
HUD_Circle.controllers              = {{"parameter_compare_with_number",0,1}}
...
HUD_ALT_ROT_R.vertices                 = hud_vert_gen(620-100,620-100)
...
HUD_ALT_ROT_R.element_params           = {"HUD_ALT_R","HUD3ONOFF"}
HUD_ALT_ROT_R.controllers              = {{"rotate_using_parameter",0,-0.0206},{"parameter_compare_with_number",0,1}}
...
HUD_test.init_pos          = {-0.0 , 0.0, 0}
HUD_test.alignment         = "RightCenter" --Left/Right/Center; Top/Down/Center
HUD_test.stringdefs        = {0.00850, 0.00850, 0.0008, 0.0}          
HUD_test.formats           = {"%.0f","%s"} 
HUD_test.element_params    = {"HUD_SPEED_DIS","GEAROFF"}
...
HUD_test.h_clip_relation   = h_clip_relations.COMPARE 
...
hud_Ngear.init_pos          = {-0.615 , -0.8 , 0}     
...
hud_NgearIN.init_pos          = {-0.62 , -0.7 , 0}     
hud_NgearIN.alignment         = "Center"       
hud_NgearIN.stringdefs        = {0.00850, 0.00850, 0.0008, 0.0}   
hud_NgearIN.formats           = {"UP","%s"} 
hud_NgearIN.element_params    = {"HUD_ANG_NUM","GEARDISSTATE"}
hud_NgearIN.controllers       = {{"text_using_parameter",0},{"parameter_compare_with_number",1,1}}
...
hud_Rgear.init_pos          = {-0.465 , -0.8 , 0}     
...
hud_RgearIN.init_pos          = {-0.47 , -0.7 , 0}     
hud_RgearIN.alignment         = "Center"       
hud_RgearIN.stringdefs        = {0.00850, 0.00850, 0.0008, 0.0}   
hud_RgearIN.formats           = {"UP","%s"} 
hud_RgearIN.element_params    = {"HUD_ANG_NUM","GEARDISSTATE",}
hud_RgearIN.controllers       = {{"text_using_parameter",0},{"parameter_compare_with_number",1,1}}
...
hud_Lgear.init_pos          = {-0.765 , -0.8 , 0}     
...
hud_LgearIN.init_pos          = {-0.765 , -0.7 , 0}     
hud_LgearIN.alignment         = "Center"       
hud_LgearIN.stringdefs        = {0.00850, 0.00850, 0.0008, 0.0}   
hud_LgearIN.formats           = {"UP","%s"} 
hud_LgearIN.element_params    = {"HUD_ANG_NUM","GEARDISSTATE"}
hud_LgearIN.controllers       = {{"text_using_parameter",0},{"parameter_compare_with_number",1,1}}
...
HUD_gear.init_pos                 = {-0.595 , -0.72 , 0}
HUD_gear.element_params           = {"GEARDISSTATE"}
HUD_gear.controllers              = {{"parameter_compare_with_number",0,1}}
HUD_gear.collimated               = true
HUD_gear.use_mipfilter            = true
HUD_gear.additive_alpha           = false
HUD_gear.isvisible		          = true
...
local HUD_gear2                    = CreateElement "ceTexPoly"
HUD_gear2.vertices                 = hud_vert_gen(850,850)
HUD_gear2.indices                  = {0,1,2,2,3,0}
HUD_gear2.tex_coords               = tex_coord_gen(0,0,2048,2048,2048,2048)
HUD_gear2.material                 = HUD_GEAR
HUD_gear2.name                     = create_guid_string()
HUD_gear2.init_pos                 = {-0.595 , -0.72 , 0}
HUD_gear2.element_params           = {"LEFTGEAR"}
HUD_gear2.controllers              = {{"parameter_compare_with_number",0,1}}
HUD_gear2.collimated               = true
HUD_gear2.use_mipfilter            = true
HUD_gear2.additive_alpha           = false
HUD_gear2.isvisible		          = true
HUD_gear2.h_clip_relation          = h_clip_relations.COMPARE
HUD_gear2.level                    = HUD_DEFAULT_NOCLIP_LEVEL +2
HUD_gear2.parent_element           = "HUD_SQUARE_CLIP"
Add(HUD_gear2)
...
HUD_VV_IND.vertices                 = hud_vert_gen(1000-200,1000-200)
...
HUD_VV_arrow.vertices                 = hud_vert_gen(900-200,900-200)
...
HUD_GX_arrow.vertices                 = hud_vert_gen(1200-200,1200-200)
HUD_GX_arrow.indices                  = {0,1,2,2,3,0}
HUD_GX_arrow.tex_coords               = tex_coord_gen(0,0,2048,2048,2048,2048) --DCLT
HUD_GX_arrow.material                 = HUD_VV_arr
HUD_GX_arrow.name                     = create_guid_string()
HUD_GX_arrow.init_pos                 = {0.25 , -0.0658 , 0}
HUD_GX_arrow.element_params           = {"HUD3ONOFF"}
HUD_GX_arrow.controllers              = {{"parameter_compare_with_number",0,1}}
...
HUD_GX_arrow_2.vertices                 = hud_vert_gen(1200-200,1200-200)
HUD_GX_arrow_2.indices                  = {0,1,2,2,3,0}
HUD_GX_arrow_2.tex_coords               = tex_coord_gen(0,0,2048,2048,2048,2048) --DCLT
HUD_GX_arrow_2.material                 = HUD_VV_arr_inverted
HUD_GX_arrow_2.name                     = create_guid_string()
HUD_GX_arrow_2.init_pos                 = {-0.25 , -0.0658 , 0}
HUD_GX_arrow_2.element_params           = {"HUD3ONOFF"}
HUD_GX_arrow_2.controllers              = {{"parameter_compare_with_number",0,1}}
