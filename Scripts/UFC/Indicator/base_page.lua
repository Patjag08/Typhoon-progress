...
UFC_RPM_ROT_L.init_pos                 = {-0.497, 0.1, 0} --L-R,U-D,F-B
...
UFC_RPM_TEXT_L.material          = "font_Display_green" 
...
UFC_RPM_TEXT_R.material          = "font_Display_green" 
...
UFC_FUEL.material          = "font_Display_green" 
UFC_FUEL.init_pos          = {0.04, -0.22, 0} --L-R,U-D,F-B
UFC_FUEL.alignment         = "RightCenter" --Left/Right/Center; Top/Down/Center
...
local UFC_FUEL_F            = CreateElement "ceStringPoly" 
UFC_FUEL_F.material          = "font_Display_green" 
UFC_FUEL_F.init_pos          = {0.15, 0.132, 0} --L-R,U-D,F-B
UFC_FUEL_F.alignment         = "RightCenter" --Left/Right/Center; Top/Down/Center
UFC_FUEL_F.stringdefs        = {0.0070, 0.0070, 0.0003, 0.0}    
UFC_FUEL_F.formats           = {"%.0f","%s"} 
UFC_FUEL_F.element_params    = {"UFC_FUEL_F"}
UFC_FUEL_F.controllers       = {{"text_using_parameter",0},}
UFC_FUEL_F.collimated        = true
UFC_FUEL_F.use_mipfilter     = true
UFC_FUEL_F.additive_alpha    = true
UFC_FUEL_F.isvisible		 = true
UFC_FUEL_F.h_clip_relation   = h_clip_relations.COMPARE 
UFC_FUEL_F.level			 = UFC_DEFAULT_NOCLIP_LEVEL +1
UFC_FUEL_F.parent_element    = "UFC_base_clip" 
Add(UFC_FUEL_F)


local UFC_FUEL_A            = CreateElement "ceStringPoly" 
UFC_FUEL_A.material          = "font_Display_green" 
UFC_FUEL_A.init_pos          = {0.15, -0.04, 0} --L-R,U-D,F-B
UFC_FUEL_A.alignment         = "RightCenter" --Left/Right/Center; Top/Down/Center
UFC_FUEL_A.stringdefs        = {0.0070, 0.0070, 0.0003, 0.0}    
UFC_FUEL_A.formats           = {"%.0f","%s"} 
UFC_FUEL_A.element_params    = {"UFC_FUEL_A"}
UFC_FUEL_A.controllers       = {{"text_using_parameter",0},}
UFC_FUEL_A.collimated        = true
UFC_FUEL_A.use_mipfilter     = true
UFC_FUEL_A.additive_alpha    = true
UFC_FUEL_A.isvisible		 = true
UFC_FUEL_A.h_clip_relation   = h_clip_relations.COMPARE 
UFC_FUEL_A.level			 = UFC_DEFAULT_NOCLIP_LEVEL +1
UFC_FUEL_A.parent_element    = "UFC_base_clip" 
Add(UFC_FUEL_A)