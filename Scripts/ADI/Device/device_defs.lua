...
local WhiteColor 			= {255, 255, 255, 50}--RGBA
local MainColor 			= {255, 255, 255, 255}--RGBA
local GreenColor 		    = {0, 80, 0, 255}
...
local ADIScreen             = {255,255,255,100}
local ADI_ladder_color      = {255,255,255,100}
...
ADI_HDG       = MakeMaterial(ADI_IND_TEX_PATH.."MFD_HSI_ROSE.dds", WhiteColor)
ADI_YAW       = MakeMaterial(ADI_IND_TEX_PATH.."Yaw.dds",WhiteColor)
